...
hi Comment guifg=DarkRed ctermfg=249 guibg=White ctermbg=15 gui=NONE cterm=NONE term=NONE
...
hi MatchParen guifg=DeepPink4 ctermfg=252 guibg=LightGray ctermbg=252 gui=underline cterm=underline term=underline
...
hi NonText guifg=DarkRed ctermfg=248 guibg=White ctermbg=15 gui=NONE cterm=NONE term=NONE
